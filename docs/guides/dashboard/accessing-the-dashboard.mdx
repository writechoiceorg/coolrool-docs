...
The COOLROOL dashboard allows you to manage your club's members, create events, and organize carpools efficiently. This guide explains the functionalities available to club administrators and how to access the dashboard.
