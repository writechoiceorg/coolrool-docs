...
On the app, users can see the events from the club that are available to join, select wether they will join as a driver or passenger, and see the drivers that are available to join and passengers that have already picked up a ride.

<Image src="media/flow-event.png" alt="Event Flow"/>
